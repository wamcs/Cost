...
public class Cost extends BaseActivity {
    ...
    public void init(){
        ...
        listView= (ListView) findViewById(R.id.layout_book_list_listview);
        recyclerView= (RecyclerView) findViewById(R.id.cost_activity_bill_recyclerview);
        titletv= (TextView) findViewById(R.id.cost_activity_head_title);
        incometv= (TextView) findViewById(R.id.cost_activity_income);
        paytv= (TextView) findViewById(R.id.cost_activity_pay);
        backgroud= (ImageView) findViewById(R.id.cost_activity_header_imageview);
        rightLayout= (LinearLayout) findViewById(R.id.rightlayout);
        leftlayout= (LinearLayout) findViewById(R.id.leftlayout);
        layout= (LinearLayout) findViewById(R.id.cost_activity_head_layout);
        fab= (ImageButton) findViewById(R.id.fab_btn_main);
        shoppingadd= (ImageButton) findViewById(R.id.layout_shopping_list_add_button);
        shoppinglist= (ListView) findViewById(R.id.item_shopping_list_listview);
        incomelayout= (LinearLayout) findViewById(R.id.cost_activity_head_income_layout);
        paylayout= (LinearLayout) findViewById(R.id.cost_activity_head_pay_layout);
